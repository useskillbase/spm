...
export async function listCommand(options: { verbose?: boolean; mine?: boolean; registry?: string }): Promise<void> {
  if (options.mine) {
...
async function listMine(registryName?: string): Promise<void> {
